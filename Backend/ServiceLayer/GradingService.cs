...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        public GradingService()
        {
            ...
            taskFacade = new TaskFacade(boardFacade);
        ...
        {
            return ts.LimitColumn(email, boardName, columnOrdinal, limit);
        }
        ...
        {
            return ts.GetColumnLimit(email, boardName, columnOrdinal);
        }
        ...
        {
            return ts.GetColumnName(email, boardName, columnOrdinal);
        }
        ...
        {
            return ts.AdvanceTask(email, boardName, columnOrdinal, taskId);
        }
        ...
        {
            return ts.GetColumn(email, boardName, columnOrdinal);
        }
        ...
        {
            string u = us.LoadData();
            string t = ts.LoadData();
            if (u == null && t == null)
        ...
        {
            LoadData();
            string t = ts.DeleteData();
            string u = us.DeleteData();
            if (u == null && t == null)
                return JsonSerializer.Serialize(new Response());
            if (u != null)
                return u;
